    ...
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 md:px-12 py-6">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Link
            href="/login"
            className="px-6 py-2.5 bg-primary hover:bg-primary-hover text-white rounded-full font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
          >
            Get Started
          </Link>
        </nav>
      ...
      <main className="relative z-10 px-6 md:px-12 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/signup"
              className="flex items-center gap-2 px-8 py-3.5 bg-primary hover:bg-primary-hover text-white rounded-full font-medium transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              Start Free Trial
            ...
            <Link
              href="/login"
              className="px-8 py-3.5 bg-background-card hover:bg-background-hover text-text-primary rounded-full font-medium border border-border transition-all duration-200"
            >
              Sign In
            </Link>
          </div>
        ...
        <div id="features" className="max-w-6xl mx-auto mt-32 grid md:grid-cols-3 gap-8">
          <div className="bg-background-card/50 backdrop-blur-sm border border-border rounded-2xl p-8 hover:border-primary/50 transition-all duration-300">
          ...
          <div className="bg-background-card/50 backdrop-blur-sm border border-border rounded-2xl p-8 hover:border-accent-purple/50 transition-all duration-300">
            <div className="w-14 h-14 rounded-xl bg-accent-purple/10 flex items-center justify-center mb-6">
          ...
          <div className="bg-background-card/50 backdrop-blur-sm border border-border rounded-2xl p-8 hover:border-accent-green/50 transition-all duration-300">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-border mt-20 py-8 px-6 md:px-12">
